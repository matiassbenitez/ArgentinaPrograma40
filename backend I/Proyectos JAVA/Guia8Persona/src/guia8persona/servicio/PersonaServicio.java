...
*/
package guia8persona.servicio;

import guia8persona.entidad.Persona;
...
public Persona crearPersona(){
    ...
    public void mostrarInforme(PersonaServicio ps, Persona p){
    ...
    public void procentajes(byte [] imc, boolean [] mayores){
        int dp = 0, pi = 0, sp = 0, mayor =0, menor = 0;
        for (int i = 0; i < 4; i++) {
            if (imc[i]<0){
                dp++;
            }else if(imc[i]==0){
        ...
        System.out.println("El porcentaje de personas por debajo del peso ideal es: " + ((float)dp/4)*100+ "%");
        System.out.println("El porcentaje de personas con peso ideal es: " + ((float)pi/4)*100+ "%");
        System.out.println("El porcentaje de personas con sobrepeso es: " + ((float)sp/4)*100+ "%");
        System.out.println("El porcentaje de personas mayores de edad es: " + ((float)mayor/4)*100+ "%");
        System.out.println("El porcentaje de personas menores de edad es: " + ((float)menor/4)*100+ "%");
    }
