...
*/
package guia8persona;

import guia8persona.entidad.Persona;
import guia8persona.servicio.PersonaServicio;

public class Guia8Persona {


    public static void main(String[] args) {
        PersonaServicio ps = new PersonaServicio();
        Persona p1, p2, p3, p4;
        p1 = new Persona("Matias",38,"H",100,(float)1.70);
        p2 = new Persona("Sebatian",25,"O",75,(float)1.56);
        p3 = new Persona("María",15,"M",45,(float)1.40);
        p4 = new Persona("Soledad",35,"M",30,(float)1.65);
        
        ps.mostrarInforme(ps, p1);
        ps.mostrarInforme(ps, p2);
        ps.mostrarInforme(ps, p3);
        ps.mostrarInforme(ps, p4);
