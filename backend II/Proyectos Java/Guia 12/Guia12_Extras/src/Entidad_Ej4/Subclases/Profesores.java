...
public class Profesores extends Empleados {
    ...
    public Profesores(String profe, int anio, int despacho, String nombre, String apell, Sexo sex, int numIdent, String estado) {
    ...
    public String toString() {
        return "Profesor | " + "Materia = " + profesor + super.toString();
    }
