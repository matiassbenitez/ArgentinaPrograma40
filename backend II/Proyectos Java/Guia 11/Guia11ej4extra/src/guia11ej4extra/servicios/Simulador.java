/**
 * Desarrollar un simulador del sistema de votación de facilitadores en EggEl sistema de votación de Egg tiene una clase llamada Alumno con los siguientes atributos:
 ...
 */
package guia11ej4extra.servicios;
...
public class Simulador {
    ...
    public ArrayList<String> generarNombres() {
        String[] nombres = {"Liam","Olivia","Noah","Emma","Sophia","Jackson","Ava","Aiden","Isabella","Lucas", "Mia","Caden","Charlotte","Grayson","Amelia","Mason","Harper","Elijah","Evelyn","Logan","Abigail","Caleb","Emily","Benjamin","Elizabeth","Henry","Mila","Sebastian","Ella","Jack","Scarlett","William","Luna","James","Sofia","Daniel","Lily","Alexander","Chloe","Michael"};
        String[] apellidos = {"González","Rodríguez","López","Martínez","Fernández","García","Pérez","Gómez","Díaz","Alvarez","Romero","Silva","Torres","Ramírez","Suárez","Rojas","Mendoza","Castro","Ortega","Vargas","Medina","Vega","Acosta","Luna","Sosa","Ramos","Cabrera","Moreno","Aguirre","Ojeda","Pereyra","Ferreira","Villalba","Domínguez","Méndez","Benítez","Herrera","Figueroa","Ponce","Carrizo"};
