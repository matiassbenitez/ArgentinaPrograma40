 ...
 */
package guia11ej4extra.entidades;
...
public class Alumno {
    ...
    public Alumno(String nombreCompleto, long dni, int cantidadVotos) {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 17 * hash + Objects.hashCode(this.nombreCompleto);
        hash = 17 * hash + (int) (this.dni ^ (this.dni >>> 32));
        hash = 17 * hash + this.cantidadVotos;
        return hash;
    }
