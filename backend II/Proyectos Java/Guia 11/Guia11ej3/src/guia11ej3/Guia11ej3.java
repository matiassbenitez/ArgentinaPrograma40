...
import guia11ej3.Servicios.MazoService;
...
public class Guia11ej3 {
    ...
    public static void main(String[] args) {
        MazoService ms = new MazoService();
        Mazo mazo = ms.crearMazo();
        System.out.println("Mazo ordenado: ");
        ms.mostrarMazo(mazo);
        ms.barajar(mazo);
        System.out.println("Mazo desordenado: ");
        ms.mostrarMazo(mazo);
        System.out.println(ms.cartasDisponibles(mazo));
        System.out.println("Dar cartas:");
        for (Carta carta : ms.darCartas(mazo)) {
